describe('security', function() {
  ...
  var $rootScope, $http, $httpBackend, status, userInfo, template;
  
  angular.module('test',[]).constant('I18N.MESSAGES', messages = {});
  beforeEach(module('security', 'test'));
  beforeEach(module('app/scripts/common/security/login/form.tpl.html'));
  beforeEach(module('template/modal/backdrop.html'));
  beforeEach(module('template/modal/window.html'));
  beforeEach(inject(function(_$rootScope_, _$httpBackend_, _$http_, $templateCache) {
    $rootScope = _$rootScope_;
    $httpBackend = _$httpBackend_;
    $http = _$http_;

		//template = $templateCache.get('app/scripts/common/security/login/form.tpl.html');
	  //$templateCache.put('scripts/common/security/login/form.tpl.html', template);
  ...
  describe('showLogin', function() {
    it("should open the dialog", function() {
      service.showLogin();
      $rootScope.$digest();
      expect(angular.element(document.querySelector('.login-form')).length).toBeGreaterThan(0);
    });
  });
